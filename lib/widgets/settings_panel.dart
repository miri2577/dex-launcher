            ...
            child: Consumer<DesktopState>(
              builder: (context, state, _) => ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  _InfoTile(icon: Icons.keyboard, label: 'Alt + Tab', value: 'Fenster wechseln'),
                  _InfoTile(icon: Icons.keyboard, label: 'Alt + F4', value: 'Fenster schliessen'),
                  _InfoTile(icon: Icons.keyboard, label: 'Ctrl + W', value: 'Fenster schliessen'),
                  _InfoTile(icon: Icons.keyboard, label: 'Meta + D', value: 'Desktop zeigen'),
                  _InfoTile(icon: Icons.keyboard, label: 'Meta + S', value: 'Einstellungen'),
                  _InfoTile(icon: Icons.keyboard, label: 'Ctrl + 1/2/3', value: 'Desktop wechseln'),
                  _InfoTile(icon: Icons.keyboard, label: 'F5', value: 'Apps aktualisieren'),
                  _InfoTile(icon: Icons.keyboard, label: 'Escape', value: 'Abbrechen'),

                  const SizedBox(height: 24),
                  _SectionTitle('Info'),
                  const SizedBox(height: 8),
                  _InfoTile(icon: Icons.info_outline, label: 'DeX Launcher', value: 'v2.0.0'),
